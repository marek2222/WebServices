...
//    {
//      Employee employee = null;
//      Console.WriteLine("License Key = " + employeeRequest.LicenceKey);
//      string cs = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
//      using (SqlConnection con = new SqlConnection(cs))
//      {
//        SqlCommand cmd = new SqlCommand("spGetEmployee", con);
//        cmd.CommandType = CommandType.StoredProcedure;
//        AddParameter(cmd, "@Id", employeeRequest.EmployeeId);
//        con.Open();
//        SqlDataReader reader = cmd.ExecuteReader();
//        while (reader.Read())
//        {
...
//        AddParameter(cmd, "@DateOfBirth", (object)employee.DOB);
//        AddParameter(cmd, "@EmployeeType",(object)employee.Type);
        
//        if (employee.Type == EmployeeType.FullTimeEmployee) {
//          AddParameter(cmd, "@AnnualSalary",employee.AnnualSalary);
//        }
//        else {
//          AddParameter(cmd, "@HourlyPay",   employee.HourlyPay);
//          AddParameter(cmd, "@HoursWorked", employee.HoursWorked);
//        }
